...
private:
    ...
    inline double face_angle(Delaunay2::Face_handle f) const {
        double a1 = angle( f->vertex(0), f->vertex(1), f->vertex(2) ); if(std::isnan(a1)) a1 = 180.0;
        double a2 = angle( f->vertex(1), f->vertex(2), f->vertex(0) ); if(std::isnan(a2)) a2 = 180.0;
        double a3 = 180 - a1 - a2; if(std::isnan(a3)) a3 = 180.0;
